...
monster.loot = {
	...
	{name = "crown armor", chance = 290},
	{name = "crown legs", chance = 360},
	{name = "crown helmet", chance = 150},
	{name = "crown shield", chance = 180},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -20, maxDamage = -240},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -10, maxDamage = -120, range = 7, shootEffect = CONST_ANI_ARROW, target = false}
}
