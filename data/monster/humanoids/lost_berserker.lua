...
monster.loot = {
	...
	{id = "gold coin", chance = 5000, maxCount = 100},
	{id = "platinum coin", chance = 9000, maxCount = 9},
	...
	{id = "brown mushroom", chance = 1510, maxCount = 2},
	{id = "iron ore", chance = 8490},
	{id = "magic sulphur", chance = 720},
	{id = "chaos mace", chance = 550},
	{id = "spiked squelcher", chance = 810},
	{id = "great mana potion", chance = 1360},
	{id = "great health potion", chance = 1360},
	{id = "terra boots", chance = 640},
	{id = "small topaz", chance = 970, maxCount = 2},
	{id = "clay lump", chance = 930},
	{id = 13757, chance = 2050},
	{id = "violet crystal shard", chance = 1500},
	{id = "brown crystal splinter", chance = 1540, maxCount = 2},
	{id = "blue crystal splinter", chance = 2610},
	{id = "green crystal fragment", chance = 2870},
	{id = "drill bolt", chance = 8210, maxCount = 10}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -10, maxDamage = -501},
