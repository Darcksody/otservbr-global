...
monster.loot = {
	...
	{name = "calopteryx cape", chance = 140},
	{name = "grasshopper legs", chance = 130}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -20, maxDamage = -150, condition = {type = CONDITION_POISON, totalDamage = 240, interval = 4000}},
