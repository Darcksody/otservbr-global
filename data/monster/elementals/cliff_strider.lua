...
monster.loot = {
	{id = "white pearl", chance = 2630, maxCount = 3},
	{id = "black pearl", chance = 2090},
	{id = "gold coin", chance = 8000, maxCount = 100},
	{id = "gold coin", chance = 8000, maxCount = 95},
	{id = "platinum coin", chance = 8000, maxCount = 10},
	{id = "red gem", chance = 2110},
	...
	{id = "great mana potion", chance = 3050, maxCount = 4},
	{id = "ultimate health potion", chance = 2560, maxCount = 2},
	{id = "crystal of balance", chance = 2690},
	{id = "crystal of power", chance = 720},
	{id = "shiny stone", chance = 1280},
	{id = "wand of defiance", chance = 2000},
	{id = "glacial rod", chance = 1240},
	{id = "blue crystal shard", chance = 2520},
	{id = "blue crystal splinter", chance = 3970, maxCount = 2},
	{id = "cyan crystal fragment", chance = 2070},
	{id = "pulverized ore", chance = 1510},
	{id = "cliff strider claw", chance = 1630},
	{id = "vein of ore", chance = 1800, maxCount = 2},
	{id = "prismatic bolt", chance = 6090, maxCount = 8},
	{id = "crystalline sword", chance = 620},
	{id = "crystal crossbow", chance = 830}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -10, maxDamage = -499},
