...
monster.loot = {
	...
	{id = "gold coin", chance = 5000, maxCount = 98},
	...
	{id = "strong health potion", chance = 1560, maxCount = 2},
	{id = "strong mana potion", chance = 1400, maxCount = 2},
	{id = "great mana potion", chance = 1400, maxCount = 2},
	{id = "mana potion", chance = 1400, maxCount = 4},
	{id = "ultimate health potion", chance = 9500, maxCount = 2},
	{id = "crystalline armor", chance = 250},
	{id = "small topaz", chance = 1650, maxCount = 3},
	{id = "shiny stone", chance = 1370},
	{id = "sulphurous stone", chance = 2070},
	{id = "wand of defiance", chance = 1300},
	{id = "green crystal shard", chance = 800},
	{id = "blue crystal splinter", chance = 1600, maxCount = 2},
	{id = "cyan crystal fragment", chance = 1300},
	{id = "pulverized ore", chance = 2050},
	{id = "vein of ore", chance = 1500},
	{id = "prismatic bolt", chance = 1550, maxCount = 5},
