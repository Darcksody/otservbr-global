...
monster.loot = {
	...
	{name = "execowtioner axe", chance = 4890},
	{name = "maimer", chance = 890},
	{name = "ornate mace", chance = 2890},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -30, maxDamage = -500, range = 4, radius = 4, effect = CONST_ME_STONES, target = true},
