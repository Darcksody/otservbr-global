...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_EARTHDAMAGE, minDamage = -150, maxDamage = -500, radius = 6, effect = CONST_ME_MAGIC_GREEN, target = false}
}

monster.defenses = {
	defense = 65,
	armor = 70,
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HEALING, minDamage = 150, maxDamage = 500, effect = CONST_ME_MAGIC_BLUE, target = false}
}
