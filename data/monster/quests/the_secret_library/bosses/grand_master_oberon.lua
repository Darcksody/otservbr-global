...
monster.loot = {
	...
	{name = "falcon battleaxe", chance = 10, maxCount = 1},
	{name = "falcon longsword", chance = 10, maxCount = 1},
	{name = "falcon mace", chance = 10, maxCount = 1},
	...
	{name = "falcon rod", chance = 10, maxCount = 1},
	{name = "falcon wand", chance = 10, maxCount = 1},
	{name = "falcon shield", chance = 10, maxCount = 1},
	{name = "falcon greaves", chance = 10, maxCount = 1},
	{name = "falcon plate", chance = 10, maxCount = 1},
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -80, maxDamage = -1200},
