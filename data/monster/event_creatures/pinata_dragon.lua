...
monster.loot = {
	...
	{name = "Store coin", chance = 20000, maxCount = 25},
	...
	{name = "Store coin", chance = 900, maxCount = 50},
	{name = "Store coin", chance = 800, maxCount = 50},
	{name = "Store coin", chance = 700, maxCount = 50},
	{name = "Store coin", chance = 600, maxCount = 50},
...
monster.defenses = {
	defense = 1,
	armor = 1,
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 10000, effect = CONST_ME_MAGIC_BLUE, target = false}
}
