...
monster.loot = {
	...
	{name = "Store coin", chance = 10000, maxCount = 50},
...
monster.defenses = {
	defense = 1,
	armor = 1,
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 15000, effect = CONST_ME_MAGIC_BLUE, target = false}
}
