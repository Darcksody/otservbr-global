...
monster.loot = {
	...
	{name = "hammer of wrath", chance = 680},
	{name = "crystal mace", chance = 5500},
	{name = "magic plate armor", chance = 380},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -800, length = 8, spread = 3, effect = CONST_ME_YELLOWENERGY, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -50, maxDamage = -500, radius = 1, shootEffect = CONST_ANI_LARGEROCK, target = true}
}
