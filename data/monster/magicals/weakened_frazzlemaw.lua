...
monster.loot = {
	...
	{id = 11306, chance = 25},
	{id = 22396, chance = 450},
	{id = 22532, chance = 1760},
	{id = 22533, chance = 1000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -155, maxDamage = -350, length = 5, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
