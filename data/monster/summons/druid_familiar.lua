...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -260, maxDamage = -320, range = 5, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_STONES, target = true},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -230, maxDamage = -280, length = 2, spread = 0, effect = CONST_ME_GROUNDSHAKER, target = false},
