...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_LIFEDRAIN, minDamage = -190, maxDamage = -230, length = 2, spread = 0, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -210, maxDamage = -250, length = 2, spread = 0, effect = CONST_ME_ENERGYHIT, target = false},
